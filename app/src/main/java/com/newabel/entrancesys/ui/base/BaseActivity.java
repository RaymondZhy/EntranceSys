package com.newabel.entrancesys.ui.base;
...
import com.newabel.entrancesys.app.listener.PermissionListener;
...
import com.newabel.entrancesys.ui.activity.MainActivity;
...
public abstract class BaseActivity<T extends BasePresenter> extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isLogin = User.getInstance().getRetCode() == 0;
