...
public class RatioImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            int horizontal_weight = ta.getInt(R.styleable.RatioImageView_horizontal_weight, 1);
            if (horizontal_weight > 1) {
                mHorizontalWeight = horizontal_weight;
            }
            int vertical_weight = ta.getInt(R.styleable.RatioImageView_vertical_weight, 1);
            if (vertical_weight > 1) {
                mVerticalWeight = vertical_weight;
            }
    ...
    public void setHorizontalWeight(int mHorizontalWeight) {
    ...
    public void setVerticalWeight(int mVerticalWeight) {
