...
public class ModuleAdapter extends BaseQuickAdapter<Map<String, Object>, BaseViewHolder> {

    private SparseArray<Integer> layouts;
    private int mLayoutType = 0;

    public ModuleAdapter(@Nullable List<Map<String, Object>> data, int mLayoutType) {
        super(data);
